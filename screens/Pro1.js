...
import ques1 from "../constants/ques1";
...
export default class Pro1 extends React.Component {
  state = {
    q: ques1[Math.floor(Math.random() * ques1.length)],
  };
  render() {
      ...
      <Block flex center style={styles.home}>
        ...
        >
          <Block flex>
            ...
            <CardCopy1 item={this.state.q[6]} />
          </Block>
          <Block center >
          <Button
            style={styles.button}
            color={theme.COLORS.WARNING}
            onPress={() => this.setState({ q: ques1[Math.floor(Math.random() * ques1.length)] })}
